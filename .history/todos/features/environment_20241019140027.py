...
def capture_initial_state(context):
    ...
    try:
        ...
        for todo in todos:
            # Capture each todo's tasksof (projects) and categories
            ...
            context.initial_todos.append(
                {
                    ...
                    "tasksof": tasksof,  # Store associated projects (tasksof)
                    "categories": categories,  # Store associated categories
                }
            )

        # Capture Global Categories
